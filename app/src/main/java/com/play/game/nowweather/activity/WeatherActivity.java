...
import com.play.game.nowweather.gson.Forecast;
import com.play.game.nowweather.gson.Weather;
import com.play.game.nowweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void loadBingPic() {
        ...
        HttpUtil.sendOkHttpRequest(requestBingPic, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                final String bingpPic = response.body().string();
                SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(WeatherActivity.this).edit();
                editor.putString("bing_pic",bingpPic);
                editor.apply();
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Glide.with(WeatherActivity.this).load(bingpPic).into(bingpicImage);
                    }
                });
            }
        });
    ...
    public void requestWeather(final String weatherId) {
        String weatherurl="http://guolin.tech/api/weather?cityid="+weatherId+"" +
                "&key=76172088cf1b4688a8e87165766707f8";
